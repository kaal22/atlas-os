# Project N.O.M.A.D. attribution notice

This product includes software derived from Project N.O.M.A.D.
...
A copy of the Apache License 2.0 is included with the installed system.
The exact upstream commit ID is recorded in each release `source-manifest.json`.
